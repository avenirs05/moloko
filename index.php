...
<div class="container-fluid d-lg-none main-screen-mob">
	<div class="row">
		<div class="col">
			...
			<!-- <p id="from-Olga-text-mob" class="text-center">от бабушки Оли</p> -->
		</div>
	</div>		    
</div>
...
<div id="our-commission-section" class="container-fluid anchor-page">
	...
	<div class="row">
		<div class="col-12 col-lg-10 wrapper ml-auto mr-auto">
			...
			<p class="action"><b>АКЦИЯ! «Приведи друга!» — </b> за каждого водителя, подключившегося к нам по вашей рекомендации, платим до 500 грн по достижении им отметки в 200 поездок и положительном балансе аккаунта.</p> 
			<p>Полные условия выплат, а также информация обо всех возможных тарифах для водителей <button id="btn-all-conditions">здесь</button>.</p>
		</div>
	</div>
</div>
